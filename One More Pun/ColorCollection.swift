...
//                let randomNumber = Int(arc4random_uniform(UInt32(puns.punsArray.count)))
//        let randomColor = UIColor(red: CGFloat(arc4random_uniform(UInt32(255)))/255, green: CGFloat(arc4random_uniform(UInt32(255)))/255, blue: CGFloat(arc4random_uniform(UInt32(255)))/255, alpha: 1)
        let randomColor = colorsArray[Int(unsignedRandomNumber)]
        return randomColor
    }
